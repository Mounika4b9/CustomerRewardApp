...
Condition : A Customer recieves 2 points for every doller spent over $100 in each transaction, plus 1 
point for every doller spent between $50 and $100 in each transaction.

## Technology Used

- [Java 17](#Java17)
- [Maven 4.0.0](Maven4.0.0)
- [SpringBoot 3.3.4](#SpringBoot3.3.4)
- [MYSQL8](#MYSQL8)

...
public class RewardServiceImpl implements RewardService {
	 ...
	 * and customer details based on customer id
	 */
	...
	public Map<String, Object> getMontlyTransactionAndDetails(Long customerId, LocalDate startDate, LocalDate endDate) {
		...
		List<TransactionDto> transactionDto = transactions.stream()
				.map(txn -> modelMapper.map(txn, TransactionDto.class)).collect(Collectors.toList());
	...
	/*
	 * Calculating total reward points and retrieve transaction details and customer
	 * details based on customer id
	 */
	...
	/*
	 * month and monthPoints between start and end date by customerID
	 */
